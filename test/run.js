...
const main =  async() => {
    const rsvpContractFactory = await hre.ethers.getContractFactory("web3Rvp.sol");
    const rsvpContract = await rsvpContractFactory.deploy();
    await rsvpContract.deployed();
    console.log("Contract deloyed to:", rsvpContract.address);
    ...
    txn = await rsvpContract.withdrawAllUnclaimedDeposit(eventID);
    wait = await txn.wait();
